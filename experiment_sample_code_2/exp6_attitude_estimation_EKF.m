...
data_filename = 'data_sample_2020.xls';
%==========================================================================
...
% Make sure sheet 4 is the magnetometer sheet in your .xls file.
% Else change the number in the next line accordingly.
data_table_gps = readtable(data_filename, 'Sheet', 4);

% Make sure sheet 5 is the magnetometer sheet in your .xls file.
% Else change the number in the next line accordingly.
data_table_mag = readtable(data_filename, 'Sheet', 5);
%==========================================================================
