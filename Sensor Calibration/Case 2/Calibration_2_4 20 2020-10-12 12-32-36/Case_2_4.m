...
%% OPEN TABLES 
data_table_acc   = readtable('Accelerometer_2_4.csv');
data_table_gyro  = readtable('Gyroscope_2_4.csv');
data_table_mag   = readtable('Magnetometer_2_4.csv');
...
bias_acc	= [mu_acc_x; mu_acc_y; mu_acc_z] - [0;g;0]		% m/s/s
...
bias_mag	= [mu_mag_x;mu_mag_y;mu_mag_z] - [-19.729;-47.6421;4.9369]	% muT
