...
%% OPEN TABLES 
data_table_acc   = readtable('Accelerometer_3_1.csv');
data_table_gyro  = readtable('Gyroscope_3_1.csv');
data_table_mag   = readtable('Magnetometer_3_1.csv');
...
bias_acc	= [mu_acc_x; mu_acc_y; mu_acc_z] - [g;0;0]		% m/s/s
...
bias_mag	= [mu_mag_x;mu_mag_y;mu_mag_z] - [-47.6421;19.729;4.9369]	% muT
