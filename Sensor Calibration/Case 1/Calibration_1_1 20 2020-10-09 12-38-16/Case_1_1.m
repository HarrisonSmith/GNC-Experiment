...
%% OPEN TABLES 
data_table_acc   = readtable('Accelerometer_1_1.csv');
data_table_gyro  = readtable('Gyroscope_1_1.csv');
data_table_mag   = readtable('Magnetometer_1_1.csv');
...
bias_mag	= [mu_mag_x;mu_mag_y;mu_mag_z] - [-19.729; -4.9369; -47.6421]	% muT
