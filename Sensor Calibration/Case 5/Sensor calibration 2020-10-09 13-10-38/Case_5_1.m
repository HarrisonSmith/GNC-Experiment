...
%% OPEN TABLES 
data_table_acc   = readtable('Accelerometer_5_1.csv');
data_table_gyro  = readtable('Gyroscope_5_1.csv');
data_table_mag   = readtable('Magnetometer_5_1.csv');
...
bias_mag	= [mu_mag_x;mu_mag_y;mu_mag_z] - [0;19.729;-47.6421]	% muT
