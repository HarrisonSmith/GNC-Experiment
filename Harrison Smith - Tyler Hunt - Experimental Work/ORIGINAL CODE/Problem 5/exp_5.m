...
title('Problem 5 Ground Truth Euler Angles', 'Interpreter', 'latex', 'FontSize', 18)
...
title('Problem 5 $\mathrm{tr}(P)$', 'Interpreter', 'latex', 'FontSize', 18)

disp('The resultant angles correctly discribe the devices movement and match ')
