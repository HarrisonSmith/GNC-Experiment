...
Omega_x = mean(movmean(gyro_x_wo_bias,596));
Omega_y = mean(movmean(gyro_y_wo_bias,596));
Omega_z = mean(movmean(gyro_z_wo_bias,596));

Omega_double_bar_b = [Omega_x; Omega_y;Omega_z];
